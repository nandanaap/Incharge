...
const Header = () => {
  ...
  return (
    <header className="shadow-xl sticky top-0 z-50" style={{backgroundColor: '#0f1a2b'}}>
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center">
            <Link to="/" className="flex items-center">
              <img src="/IN-Charge-LOGO.png" alt="InCharge Logo" className="h-10 sm:h-12 w-auto hover:scale-105 transition-transform duration-300" />
            </Link>
          </div>
          
          <div className="hidden md:flex items-center space-x-6 lg:space-x-8">
            <Link to="/" className="text-white font-bold hover:text-gray-200 transform hover:scale-110 transition-all duration-300 text-sm lg:text-base">Home</Link>
            <Link to="/services" className="text-white font-bold hover:text-gray-200 transform hover:scale-110 transition-all duration-300 text-sm lg:text-base">Services</Link>
            <Link to="/about" className="text-white font-bold hover:text-gray-200 transform hover:scale-110 transition-all duration-300 text-sm lg:text-base">About</Link>
           
            <a href="https://api.whatsapp.com/send?phone=917058125603" target="_blank" rel="noopener noreferrer" className="text-white hover:text-gray-200 transform hover:scale-110 transition-all duration-300">
            ...
            <button 
              ...
              className="text-white px-4 lg:px-6 py-2 lg:py-3 rounded-lg hover:bg-opacity-80 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl animate-pulse-slow cursor-pointer text-sm lg:text-base"
        ...
        {isOpen && (
          <div className="md:hidden animate-fade-in">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 rounded-lg mt-2" style={{backgroundColor: '#0f1a2b'}}>
